@extends('layouts.master')
    @section('content')
        ...
        <section class="section breadcrumb-modern context-dark parallax-container" data-parallax-img="{{ asset('assets/images/Dept/Faculties/Headers/mgt-h.jpg') }}">
                        ...
                        <div style="padding-bottom: 20px;">
                            <div class="inset-lg-right-60">
                                ...
                                <div class="offset-lg-top-30">
                                    <p>Via active advisory boards and frequent interaction with commerce and industry, the Faculty of Management Sciences prides itself on staying current with the ever-changing demands, opportunities, and challenges of the labor market. Students interested in accounting, entrepreneurship, human resource management, economics, and taxation can choose from a range of study choices.</p>
                                </div>
                                <h3 class="text-bold veil reveal-lg-block">Departments</h3>
                                <div class="offset-top-30">
                                    <p><span class="fa fa-arrow-right"></span> 
                                        <a href="{{ route('dept', 'accounting') }}">Accounting</a>
                                    </p><br>
                                    <p><span class="fa fa-arrow-right"></span> 
                                        <a href="{{ route('dept', 'business-admin') }}">Business Administration</a>
                                    </p><br>
                                    <p><span class="fa fa-arrow-right"></span> 
                                        <a href="{{ route('dept', 'economics') }}">Economics</a>
                                    </p><br>
                                    <p><span class="fa fa-arrow-right"></span> 
                                        <a href="{{ route('dept', 'taxation') }}">Taxation</a>
                                    </p>
                                </div>
                            </div>
