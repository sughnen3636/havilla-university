            ...
            <div class="shell">
                <div class="responsive-tabs responsive-tabs-classic vertical" data-type="vertical">
                        ...
                        <div>
                            <div class="inset-lg-right-60">
                                ...
                                <div class="offset-lg-top-30">
                                    ...
                                    <a class="btn btn-default apply-btn" href="{{ route('apply') }}"><span data-novi-id="3">Get an education with value</span></a>
                                </div>
                    ...
                    <ul class="resp-tabs-list tabs-1 text-center tabs-lg-collapsed" data-group="tabs-lg-collapsed">
                        <li class="resp-tab-item tabs-lg-collapsed resp-tab-active" aria-controls="tabs-lg-collapsed_tab_item-0" role="tab">Our Philosophy</li>
                        <li class="resp-tab-item tabs-lg-collapsed resp-tab-active" aria-controls="tabs-lg-collapsed_tab_item-1" role="tab">Our Mision</li>
                        ...
                        <li class="resp-tab-item tabs-lg-collapsed resp-tab-active" aria-controls="tabs-lg-collapsed_tab_item-3" role="tab">Our Core Values</li>
