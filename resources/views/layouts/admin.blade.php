...
<body>
      ...
      <div class="main-sidebar sidebar-style-2">
        <aside id="sidebar-wrapper">
          ...
          <ul class="sidebar-menu">
            ...
            <li class="dropdown">
              <a href="#" class="menu-toggle nav-link has-dropdown"><i class="fa fas fa-user-friends"></i><span>Staff</span></a>
              <ul class="dropdown-menu">
                {{-- <li><a class="nav-link" href="chat.html">View All</a></li> --}}
                <li><a class="nav-link" href="{{ route('add-bot') }}">Add BOT</a></li>
                <li><a class="nav-link" href="{{ route('bots') }}">All BOTs</a></li>
              </ul>
            </li>
            <li class="dropdown">
  ...
  <script src="{{ asset('assets/dash/bundles/datatables/datatables.min.js')}}"></script>
  <script src="{{ asset('assets/dash/bundles/datatables/DataTables-1.10.16/js/dataTables.bootstrap4.min.js')}}"></script>
