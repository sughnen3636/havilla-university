@extends('layouts.master')
    @section('content')
        ...
        <section class="section breadcrumb-modern context-dark parallax-container" data-parallax-img="{{ asset('assets/images/Dept/Faculties/Headers/natural-h.jpg') }}">
                        ...
                        <div style="padding-bottom: 20px;">
                            <div class="inset-lg-right-60">
                                ...
                                <div class="offset-lg-top-30">
                                    <p>The Faculty is dedicated to providing courses with a clear practical dimension, ensuring that all students acquire trust and expertise in a wide variety of skills.

                                    Fieldwork skills are perceived to be an integral part of these functional skills, so fieldwork would be a central component of many of the Faculty's departments/units.</p>
                                </div>
                                ...
                                <div class="offset-top-30">
                                    ...
                                    <p><span class="fa fa-arrow-right"></span> 
                                        <a href="{{ route('dept', 'chemistry') }}">Chemistry</a>
                                    </p><br>
                                    <p><span class="fa fa-arrow-right"></span> 
                                        <a href="{{ route('dept', 'mathematics') }}">Mathematics</a>
                                    </p><br>
                                    <p><span class="fa fa-arrow-right"></span> 
