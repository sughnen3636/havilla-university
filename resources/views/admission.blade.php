    ...
    @section('content')
        <section class="section breadcrumb-modern context-dark parallax-container" data-parallax-img="{{ asset('assets/images/Slider-3.jpg')}}">
            <div class="parallax-content section-30 section-sm-70">
                <div class="shell">
                    <h2 class="veil reveal-sm-block">Undergraduate Admission</h2>
            ...
            <div class="shell">
                <div class="responsive-tabs responsive-tabs-classic vertical" data-type="vertical">
                    <div class="resp-tabs-container text-sm-left tabs-lg-collapsed" data-group="tabs-lg-collapsed">
                                    ...
                                    <table class="table table-bordered">
                                      ...
                                      <tbody>
                                        <tr>
                                          ...
                                          <td style="padding-left: 10px!important;">Unavailable for 2021/2022 session
                                          </td>
                                    ...
                                    <table class="table table-bordered">
                                      ...
                                      <tbody>
                                        <tr>
                                          ...
                                          <td style="padding-left: 10px!important;">Unavailable for 2021/2022 session</td>
                        ...
                        <div>
                            <div class="inset-lg-right-60">
                                <h3 class="text-bold veil reveal-lg-block">Begin a great educational journey today!</h3>
                                <div class="hr divider bg-madison hr-sm-left-0 veil reveal-lg-block"></div>
                                <div class="offset-lg-top-30">
                    ...
                    <ul class="resp-tabs-list tabs-1 text-center tabs-lg-collapsed" data-group="tabs-lg-collapsed">
                        <li class="resp-tab-item tabs-lg-collapsed resp-tab-active" aria-controls="tabs-lg-collapsed_tab_item-0" role="tab">General Requirements</li>
                        <li class="resp-tab-item tabs-lg-collapsed resp-tab-active" aria-controls="tabs-lg-collapsed_tab_item-0" role="tab">Fees Schedule</li>
                        <li class="resp-tab-item tabs-lg-collapsed resp-tab-active" aria-controls="tabs-lg-collapsed_tab_item-1" role="tab">Faculty & Departmental Requirements</li>
                        ...
                        <li class="resp-tab-item tabs-lg-collapsed resp-tab-active" aria-controls="tabs-lg-collapsed_tab_item-4" role="tab">
                          <img src="{{ asset('assets/images/scholarship.jpg') }}">
                        </li>
